  ...
  return (
    <main className="flex min-h-screen flex-col items-start md:items-center justify-between pt-24 md:p-24">
      ...
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 flex w-full justify-center border-b pb-6 pt-8 backdrop-blur-2xl border-neutral-800 bg-zinc-800/30 from-inherit   lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:bg-zinc-800/30">
          the user grid&nbsp;
        </p>
